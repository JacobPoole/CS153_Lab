...
_test_user:     file format elf32-i386
...
int main (int argc, char *argv[]){
  ...
  24:	e8 e1 02 00 00       	call   30a <setpriority>
   exit();
  29:	e8 24 02 00 00       	call   252 <exit>
  2e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 359:	0f b6 92 4f 07 00 00 	movzbl 0x74f(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ce:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 4ef:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 4f1:	b8 48 07 00 00       	mov    $0x748,%eax
